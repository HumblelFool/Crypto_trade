...
export const getWithdrawalHistory = (jwt) => async (dispatch) => {
  ...
  try {
    const response = await api.get(`/api/withdrawal/withdrawalHistory`, {
      headers: {
        Authorization: `Bearer ${jwt}`,
      },
    });

    console.log("get withdrawl history ----", response.data);
    dispatch({
...
export const getAllWithdrawalRequest = (jwt) => async (dispatch) => {
  ...
  try {
    ...
    console.log("get withdrswal request----", response.data);
    dispatch({
...
export const addPaymentDetails =
  ...
  async (dispatch) => {
    ...
    try {
      ...
      console.log("add payment detaisl---", response.data);
      dispatch({
